...
contract FundMeTest is Test {
    ...
    function testMinnimumDollarIsFive() public view {
    ...
    function testPriceFeedVersioIsAccurate() public view {
        uint256 version = fundMe.getVersion();
        assertEq(version, 4);
    }

    function testFundFailsWithoutEnoughEth() public {
        vm.expectRevert(); //this tells that the next line should revert
        fundMe.fund{value: 1}();
    }
